  ...
  activeLocal.skills.forEach((skill) => {
    ...
    skillButton.addEventListener("click", function () {
      if (activeEncounter.hp == 0) {
        ...
        document.getElementById("localImg").classList.remove("localImgAnim");
        document.getElementById("localImg").classList.add("localImgAnim");
...
function enemyAttack() {
  ...
  document.getElementById("enemyImg").classList.remove("enemyImgAnim");
  document.getElementById("enemyImg").classList.add("enemyImgAnim");
}
